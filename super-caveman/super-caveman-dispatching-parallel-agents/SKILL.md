...
3. During dispatching-parallel-agents, invoke `caveman` skill for main-thread responses unless the user says otherwise.
4. During dispatching-parallel-agents, every spawned subagent should also be told to invoke `caveman` skill unless the user says otherwise.

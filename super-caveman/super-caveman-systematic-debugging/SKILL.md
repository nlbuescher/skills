...
3. During systematic-debugging, invoke `caveman` skill for main-thread responses unless the user says otherwise.
4. During systematic-debugging, every spawned subagent should also be told to invoke `caveman` skill unless the user says otherwise.

...
3. During subagent-driven-development, invoke `caveman` skill for main-thread responses unless the user says otherwise.
4. During subagent-driven-development, every spawned subagent should also be told to invoke `caveman` skill unless the user says otherwise.

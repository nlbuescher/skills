...
3. During verification-before-completion, invoke `caveman` skill for main-thread responses unless the user says otherwise.
4. During verification-before-completion, every spawned subagent should also be told to invoke `caveman` skill unless the user says otherwise.

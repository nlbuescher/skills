...
3. During writing-plans, invoke `caveman` skill for main-thread responses unless the user says otherwise.
4. During writing-plans, every spawned subagent should also be told to invoke `caveman` skill unless the user says otherwise.
